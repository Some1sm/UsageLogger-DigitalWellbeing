    ...
    public static class TrayManager
    {
        ...
        public static void LaunchUI()
        {
            try
            {
                ...
                {
                    Path.Combine(AppContext.BaseDirectory, "UsageLogger.exe"),
                    Path.Combine(AppContext.BaseDirectory, "..", "UsageLogger.exe"),
                    Path.Combine(AppContext.BaseDirectory, "..", "UsageLogger", "UsageLogger.exe")
                };
                ...
                if (uiPath != null)
                {
                    ...
                    // var existing = Process.GetProcessesByName("UsageLogger"); ...
